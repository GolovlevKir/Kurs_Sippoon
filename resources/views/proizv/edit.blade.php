    ...
    <div class="row col-md-9 col-lg-9 col-sm-9 pull-left">
        <div class="container">
            ...
            <div class="row" col-md-12 col-sm-12 col-lg-12 style="background: white; margin: 10px">
                <form method="post" action="{{route ('proizv.update',[$proizvoditeli -> id])}}">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        name="name" spellcheck="false" class="form-control" value="{{$proizvoditeli -> name}}">
                    </div>
                    <div class="form-group">
    ...
    <div class="col-sm-3 col-md-3 col-lg-3 pull-right">
        ...
        <div class="sidebar-module">
            ...
            <ol class="list-unstyled">
                ...
                <li><a href="/proizv/{{$proizvoditeli -> id}}">Перейти к типам</a></li>
            </ol>
        </div>
        <!--<div class="sidebar-module">
            <h4>Archives</h4>
